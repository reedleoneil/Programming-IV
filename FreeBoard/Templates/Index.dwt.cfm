	...
	<body>
		...
		<div class="bannerArea">
			<div class="container">
				...
				<div class="toplogo"><a href="#"><a href="#"><a href="#"></a><a href="#"><img src="../images/prime_logo.png" width="202" height="48" border="0" /></a></a></a></div>
				...
				<div class="contentleft">
				  <div class="container"><!-- TemplateBeginEditable name="content" -->
				    <div class="contentleft">
				      ...
				      <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Morbi commodo, ipsum sed pharetra gravida, orci magna rhoncus neque, id pulvinar odio lorem non turpis. Nullam sit amet enim. Suspendisse id velit vitae ligula volutpat condimentum. Aliquam erat volutpat. Sed quis velit. Nulla facilisi. Nulla libero. Vivamus pharetra posuere sapien. Nam consectetuer. Sed aliquam, nunc eget euismod ullamcorper, lectus nunc ullamcorper orci, fermentum bibendum enim nibh eget ipsum. <a href="#">Donec porttitor ligula</a> eu dolor. Maecenas vitae nulla consequat libero cursus venenatis. Lorem ipsum dolor sit amet.</p>
				      <h3>Consectetuer adipiscing</h3>
				      <p>Consectetuer adipiscing elit. Morbi commodo, ipsum sed pharetra gravida, orci magna rhoncus neque, id pulvinar odio lorem non turpis. Nullam sit amet enim. Suspendisse id velit vitae ligula volutpat condimentum. Aliquam erat volutpat. Sed quis velit. Nulla facilisi. Nulla libero.</p>
				      <ul>
				        <li><a href="#">Vivamus pharetra</a></li>
				        <li><a href="#">Posuere sapien</a></li>
				        <li><a href="#">Nam consectetuer</a></li>
			          </ul>
		...
		<div class="footerArea">
			<div class="container"> 
				<div class="copyright">&copy; 2013 Free-Board.  All rights reserved.</div>
			</div>
		</div>
